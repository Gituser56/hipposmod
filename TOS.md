...
2. Licensing:
ALL code and materials contained within this repository are released under the MIT License, meaning you are free to use, modify, and distribute this software according to the License text, though you have to credit the original creator as they claim copyright over this project. (MUST CREDIT REDSQUARE STUDIOS)
...
5. Acceptable Use & Contributions:
